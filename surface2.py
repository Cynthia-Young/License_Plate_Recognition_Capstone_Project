...
from PlateRecognition import Recognition
big = False
...
class Ui_MainWindow(QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        MainWindow.setFixedSize(1213, 700)  # 设置窗体固定大小
        ...
        self.scrollArea.setGeometry(QtCore.QRect(10, 150, 511, 490))
        ...
        self.scrollArea_2.setGeometry(QtCore.QRect(530, 40, 671, 601))
        self.scrollArea_2.setWidgetResizable(True)
        self.scrollArea_2.setObjectName("scrollArea_2")

        # 识别结果区域组件
        self.scrollAreaWidgetContents_2 = QtWidgets.QWidget()
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 669, 599))
        self.scrollAreaWidgetContents_2.setObjectName("scrollAreaWidgetContents_1")
        ...
        self.tableWidget.setGeometry(QtCore.QRect(10, 40, 651, 551))  # 551))
        self.tableWidget.setObjectName("tableWidget")
        self.tableWidget.setColumnCount(5)
        self.tableWidget.setColumnWidth(0, 134)  # 设置1列的宽度
        self.tableWidget.setColumnWidth(1, 124)  # 设置2列的宽度
        self.tableWidget.setColumnWidth(2, 104)  # 设置3列的宽度
        self.tableWidget.setColumnWidth(3, 84)  # 设置4列的宽度
        self.tableWidget.setColumnWidth(4, 175)  # 设置5列的宽度
        ...
        self.scrollArea_3.setGeometry(QtCore.QRect(180, 10, 341, 131))
        ...
        self.scrollArea_4.setGeometry(QtCore.QRect(10, 10, 161, 131))
    ...
    def __openimage(self):
        ...
        if result is not None:
            self.Data.append([filename, result['InputTime'], result['Number'], result['Type'], result['From']])
